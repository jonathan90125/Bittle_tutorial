...
//  for(int i=0;i<=34;i++){
//    for(int j=0;j<=7;j++){
//   //   Serial.print(int(trF[i][j]));
//      pwm.setPWM(pins[8+j],0,S2P(  30+((int(trF[i][j])-30)*0.5) ,8+j ));
//   //   Serial.print(',');
//    }
//    }
//  }
...
//  for(int i=0;i<=35;i++){
//    for(int j=0;j<=7;j++){
//   //   Serial.print(int(trL[i][j]));
//      pwm.setPWM(pins[8+j],0,S2P(  30+((int(trL[i][j])-30)*0.5) ,8+j ));
//   //   Serial.print(',');
//    }
//    }
//  }
...
//  for(int i=0;i<=35;i++){
//    for(int j=0;j<=7;j++){
//   //   Serial.print(int(trR[i][j]));
//      pwm.setPWM(pins[8+j],0,S2P(  30+((int(trR[i][j])-30)*0.5) ,8+j ));
//   //   Serial.print(',');
//    }
//    }
//  }
